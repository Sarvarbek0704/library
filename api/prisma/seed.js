...
async function main() {
    ...
    const books = await Promise.all(bookData.map((b) => prisma.book.create({ data: b })));
    ...
    const memberData = [
        { user: users[0], membership: memberships[0], method: 'CARD' },
        { user: users[1], membership: memberships[1], method: 'CASH' },
        { user: users[2], membership: memberships[2], method: 'ONLINE' },
        { user: users[3], membership: memberships[0], method: 'CARD' },
        { user: users[4], membership: memberships[1], method: 'CASH' },
        { user: users[5], membership: memberships[2], method: 'CARD' },
        { user: users[6], membership: memberships[1], method: 'ONLINE' },
        { user: users[7], membership: memberships[0], method: 'CASH' },
        { user: users[8], membership: memberships[2], method: 'CARD' },
        { user: users[9], membership: memberships[1], method: 'ONLINE' },
    ];
    ...
    const returnedConfigs = [
        ...
        { memberIdx: 0, bookIdx: 3, score: Math.floor(books[3].pages / 50) },
    ];
    ...
    const historyData = [
        { userId: demoUser.id, bookId: books[3].id, borrowedAt: pastDate(30), returnedAt: pastDate(10), status: 'RETURNED' },
        { userId: users[0].id, bookId: books[0].id, borrowedAt: pastDate(40), returnedAt: pastDate(20), status: 'RETURNED' },
        { userId: users[0].id, bookId: books[6].id, borrowedAt: pastDate(25), returnedAt: pastDate(5), status: 'RETURNED' },
        { userId: users[1].id, bookId: books[2].id, borrowedAt: pastDate(35), returnedAt: pastDate(15), status: 'RETURNED' },
        { userId: users[1].id, bookId: books[8].id, borrowedAt: pastDate(20), returnedAt: pastDate(3), status: 'RETURNED' },
        { userId: users[2].id, bookId: books[4].id, borrowedAt: pastDate(45), returnedAt: pastDate(25), status: 'RETURNED' },
        { userId: users[3].id, bookId: books[10].id, borrowedAt: pastDate(60), returnedAt: pastDate(40), status: 'RETURNED' },
        { userId: users[4].id, bookId: books[18].id, borrowedAt: pastDate(15), returnedAt: pastDate(2), status: 'RETURNED' },
        { userId: users[5].id, bookId: books[21].id, borrowedAt: pastDate(28), returnedAt: pastDate(8), status: 'RETURNED' },
        { userId: users[6].id, bookId: books[25].id, borrowedAt: pastDate(22), returnedAt: pastDate(2), status: 'RETURNED' },
        { userId: users[7].id, bookId: books[13].id, borrowedAt: pastDate(18), returnedAt: pastDate(1), status: 'RETURNED' },
        { userId: users[8].id, bookId: books[9].id, borrowedAt: pastDate(50), returnedAt: pastDate(30), status: 'RETURNED' },
        { userId: users[9].id, bookId: books[27].id, borrowedAt: pastDate(12), returnedAt: null, status: 'BORROWED' },
        { userId: demoUser.id, bookId: books[5].id, borrowedAt: pastDate(55), returnedAt: pastDate(35), status: 'RETURNED' },
        { userId: users[0].id, bookId: books[16].id, borrowedAt: pastDate(8), returnedAt: null, status: 'BORROWED' },
    ];
